...
export class TimeStudyTreeLayout {
  constructor(type, scaling = 1) {
    ...
    if (type === STUDY_TREE_LAYOUT_TYPE.ALTERNATIVE_62 || type === STUDY_TREE_LAYOUT_TYPE.ALTERNATIVE_62_181 ||
      ...
      this.rows.push(
        normalRow(                      TS(41), TS(42), EC(5)                      ),
        normalRow(                               TS(51),TS(52),TS(43)                                 )
      );
    } else {
      this.rows.push(
        normalRow(                           TS(41), TS(42),TS(43)                             ),
        normalRow(                      TS(51),   TS(52),  EC(5)                         )
      );
    }
    ...
    this.rows.push(
      ...
      normalRow(           null  , TS(151),   TS(152), TS(153),EC(4)                ),
      normalRow(                          TS(161),EC(9), TS(162)                            )
    );

    if (type === STUDY_TREE_LAYOUT_TYPE.ALTERNATIVE_181 || type === STUDY_TREE_LAYOUT_TYPE.ALTERNATIVE_62_181 ||
      type === STUDY_TREE_LAYOUT_TYPE.ALTERNATIVE_TRIAD_STUDIES) {
      this.rows.push(
        normalRow(                         EC(3), TS(171),  EC(2)                        ),
        normalRow(                        EC(1), null,  null                        )
      );
    } else {
      this.rows.push(
        normalRow(                               TS(171)                                ),
    ...
    this.rows.push(
      ...
      normalRow(                         TS(241), TimeStudy.dilation,TS(242)                          ),
      normalRow(          TS(251),TimeStudy.timeDimension(5), TimeStudy.timeDimension(6),TS(252)      ),
      normalRow(          TimeStudy.timeDimension(7), TimeStudy.timeDimension(8)      ),
      normalRow(                          TimeStudy.reality                        ),
      normalRow(                          TS(261)                       ),
      normalRow(                          TS(271),TS(272)                       ),
      normalRow(                          TS(281),null                       ),
      normalRow(                          TS(291),null                       ),
