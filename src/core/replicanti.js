...
export const ReplicantiUpgrade = {
  ...
  galaxies: new class ReplicantiGalaxiesUpgrade extends ReplicantiUpgradeState {
    ...
    get extra() {
      return Effects.max(0, TimeStudy(131)) + Math.round(TimeStudy(132).effectOrDefault(0)*ReplicantiUpgrade.galaxies.value) + PelleRifts.decay.milestones[2].effectOrDefault(0);
    }
