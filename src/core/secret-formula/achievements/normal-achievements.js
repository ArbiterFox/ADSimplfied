...
export const normalAchievements = [
  {
    ...
    reward: "Replace all your antimatter dimensions autobuyer with continuum and permantly unlocks tickspeed,continuum purchases 5% more",
    effect: () => 1.05
  },
  {
    id: 12,
  ...
  },
  {
    ...
    description: "Have a 3rd Antimatter Dimension.",
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    id: 14,
    name: "L4D: Left 4 Dimensions",
    description: "Have a 4th Antimatter Dimension.",
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
    reward: "Antimatter Dimensions multi based on current AM",
    effect: () => player.antimatter.log10()**0.5,
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 15,
    name: "5 Dimension Antimatter Punch",
    description: "Have a 5th Antimatter Dimension.",
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    id: 16,
    ...
    get description() {
      return Enslaved.isRunning
        ? "Have a 6th Antimatter Dimension (they never amount to anything)"
        : "Have a 6th Antimatter Dimension.";
    },
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    ...
    description: "Have a 7th Antimatter Dimension.",
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
    id: 18,
    ...
    get description() {
      return Enslaved.isRunning
        ? "Have an 8th Antimatter Dimension (don't get used to it)"
        : "Have an 8th Antimatter Dimension.";
    },
    checkEvent: GAME_EVENT.ACHIEVEMENT_EVENT_OTHER,
  },
  {
  ...
  },
  {
    id: 22,
    name: "FAKE NEWS!",
    get description() { return `Encounter ${formatInt(5)} different news messages.`; },
    checkRequirement: () => NewsHandler.uniqueTickersSeen >= 5,
    checkEvent: GAME_EVENT.REALITY_RESET_AFTER,
    get reward() { return `Every News Ticker seen count as 10`; },
    effect: 10
  },
  {
    id: 23,
    name: "The 9th Dimension is a lie",
    get description() { return `Have over ${formatInt(99)} 8th Antimatter Dimensions.`; },
  ...
  },
  {
    ...
    reward: "10 additional free TicksSpeed Upgrades",
    effect: () => 10
  },
  {
    id: 27,
    ...
    reward: "IP mult based on how far you are from 7 galaxies",
    effect: () => Math.max(Math.pow(Math.abs(7-player.galaxies),1.5),1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 28,
    ...
    get description() {
      return `Have over ${format(DC.E150)} of 1st AD.`;
    },
  ...
  {
    id: 35,
    name: "I don't dare sleep",
    get description() {
      return PlayerProgress.realityUnlocked()
        ? `Be offline for a period of less than ${formatInt(6)} hours (real time).`
        : `Be offline for a period of less than ${formatInt(6)} hours.`;
    },
  ...
  {
    id: 43,
    name: "How the tables have anti-turned..",
    description:
      "Get the 1st Antimatter Dimension multiplier to be highest, 2nd Antimatter Dimension multiplier " +
      " second highest, etc.",
    checkRequirement: () => {
  ...
  },
  {
    ...
    reward: "IP mult based on current AM (caps at 1e4)",
    effect: () => Math.min(Math.pow(player.antimatter.log10(),0.4),1e4),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 52,
  ...
  {
    id: 76,
    name: "One milisecond for each dimension",
    get description() { return `Play for ${formatInt(8)} Miliseconds.`; },
    checkRequirement: () => Time.totalTimePlayed.totalMilliseconds >= 8,
    checkEvent: GAME_EVENT.GAME_TICK_AFTER,
    reward: "Extremely small multiplier to Antimatter Dimensions based on time played.",
    effect: () => Math.max(Math.pow(Time.totalTimePlayed.totalMilliseconds / 2, 0.1), 1),
    formatEffect: value => `${formatX(value, 2, 2)}`
  },
  {
    id: 77,
  ...
  },
  {
    id: 108,
    name: "We COULDN'T afford 9",
    get description() { return `Eternity with less than ${formatInt(9)}.`; },
    checkRequirement: () => Replicanti.amount.round().lessThan(9),
    checkEvent: GAME_EVENT.ETERNITY_RESET_BEFORE
  },
  {
    id: 111,
  ...
  },
  {
    ...
    reward: "A fading sense of accomplishment.Also generate ^0.2 of IP you would gain on crunch.",
    effect: () => gainedInfinityPoints().pow(0.2).times(Time.deltaTime / 100)
  ...
  },
  {
    ...
    get description() { return `Reach ${formatPostBreak("1e22000")} Infinity Points with Time Studies.`; },
  ...
  },
  {
    ...
    get description() {
      return `Reach ${formatPostBreak("1e26000")} Infinity Points with any Time Studies while Dilated.`;
    },
    checkRequirement: () =>
  ...
  },
  {
    ...
    description: "Have more than 10 Perks at once.",
    checkRequirement: () => player.reality.perkPoints >= 10,
