export const secretAchievements = [
  {
    ...
    description: "Click on this Achievement. reward: V's first requirement is now free(reality to get it!).",
    reward: "V's first requirement is now free.",
    effect: () => Math.max(10000-player.realities,1)
  },
  {
    id: 12,
    name: "Just in case",
