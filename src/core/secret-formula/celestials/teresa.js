export const teresa = {
  unlocks: {
    ...
    epGen: {
      id: 1,
      price: 1e10,
      description: "Unlock more perks.",
      isDisabledInDoomed: false
    },
    effarig: {
      id: 2,
      price: 1e21,
    ...
    shop: {
      id: 3,
      price: 1e24,
      description: "You can overpour the bar (Max 1e300) and the reward formula is improved. Also unlocks perkshop.",
    },
    undo: {
      id: 4,
      price: 1e18,
