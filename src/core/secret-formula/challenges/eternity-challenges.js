...
export const eternityChallenges = [
  ...
  },
  {
    ...
    description: () => `all Dimension multipliers and powers are disabled except for the multipliers from
      Infinity Power and Dimension Boosts (to Antimatter Dimensions),however,the game runs ×${formatInt(1000000)} faster; all other game speed effects are disabled . ${specialInfinityGlyphDisabledEffectText()}`,
    goal: DC.E650,
    pelleGoal: DC.E11200,
    goalIncrease: DC.E250,
