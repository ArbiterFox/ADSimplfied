...
export const perks = {
  ...
  moreChoice: {
    ...
    family: PERK_FAMILY.REALITY,
    get description() {
      return `allow you to choose from ${formatInt(8)} more different Glyphs on Reality.`;
    },
    effect: 8,
    layoutPosList: [80203, 80203, 80203, 80203, 80191, 67772],
  },
  moreSlots: {
    id: 2,
    label: "GHRD",
    family: PERK_FAMILY.REALITY,
    get description() {
      return `You can now hold 50% more glyphs.`;
    },
    effect: 1.5,
    layoutPosList: [80204, 80204, 80204, 80204, 80192, 67773],
  },
  moreEffects: {
    id: 3,
    label: "EFCT+",
    family: PERK_FAMILY.REALITY,
    get description() {
      return `Glyphs have a 25% chance to get an extra effect.`;
    },
    effect: 0.25,
    layoutPosList: [80205, 80205, 80205, 80205, 80193, 67774],
  },
  GLupd: {
    id: 4,
    label: "GLUPD",
    family: PERK_FAMILY.REALITY,
    get description() {
      return `On Reality,update all your GL if pendingGL is higher than yours.`;
    },
    layoutPosList: [80206, 80206, 80206, 80206, 80194, 67775],
  },
  GLupdplus: {
    id: 5,
    label: "GLUPD+",
    family: PERK_FAMILY.REALITY,
    get description() {
      return `Improve GLUPD to work every tick.`;
    },
    layoutPosList: [80206, 80206, 80206, 80206, 80194, 67775],
  },
  NR181: {
    ...
    get description() {
      return `Permanently keeps TS181. This perk is automatically granted after getting GATE.`;
    },
  ...
  studyPassive: {
    ...
    family: PERK_FAMILY.ETERNITY,
    get description() {
      return `Remove EC10 requirement from lower tree studies`;
    },
  ...
  autocompleteEC4: {
    ...
    family: PERK_FAMILY.AUTOMATION,
    get description() {
      return `All PEC perks run 10000 times faster.`;
    },
    effect: 10000,
    automatorPoints: 100,
    layoutPosList: [106265, 78602, 81401, 80204, 79403, 61903],
  ...
  improve181: {
    ...
    family: PERK_FAMILY.ETERNITY,
    get description() {
      return `Improve TS181 to generate EP as well.`;
    },
    layoutPosList: [29761, 81402, 81403, 79404, 79803, 84639],
  },
  gateway: {
...
export const perkConnections = (function() {
  ...
  const groups = [
    [p.firstPerk, p.achievementGroup1, p.startAM, p.autounlockEU1, p.bypassEC5Lock,p.moreChoice],
    [p.moreChoice,p.moreSlots],
    [p.moreSlots,p.moreEffects],
    [p.GLupd,p.moreEffects],
    [p.GLupd,p.GLupdplus],
