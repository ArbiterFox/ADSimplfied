...
export const Tickspeed = {
  ...
  get continuumValue() {
    ...
    return this.costScale.getContinuumValue(Currency.antimatter.value, 1) * Laitela.matterExtraPurchaseFactor*Achievement(11).effectValue*TimeStudy(1).effectValue*Achievements.contin;
  },
  ...
  get totalUpgrades() {
    ...
    return boughtTickspeed + player.totalTickGained + Achievement(26).effectValue;
  },
